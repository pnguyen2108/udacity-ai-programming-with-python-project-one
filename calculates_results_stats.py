...
def calculates_results_stats(results_dic):
    ...
    for key, values in results_dic.items():
        ...
        if not is_dog and not classified_as_dog:
        ...
        if results_stats_dic['n_dogs_img'] > 0:
            results_stats_dic['pct_correct_dogs'] = (results_stats_dic['n_correct_dogs'] * 100) / results_stats_dic[
                'n_dogs_img']
            results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed'] * 100) / results_stats_dic[
                'n_dogs_img']

        if results_stats_dic['n_notdogs_img'] > 0:
            results_stats_dic['pct_correct_notdogs'] = (results_stats_dic['n_correct_notdogs'] * 100) / \
